...
//Create
//Below thing is used for form
router.post("/addbroadband/:userId",addBroadBand); //isSignedIn,isAuthenticated

//router.post("/addbroadband/",addBroadBand); //isSignedIn,isAuthenticated
